...
namespace LibNoise
{
    internal static class Utils
    {
        ...
        internal const int OctavesMaximum = 50;
        ...
        {
            var i = (GeneratorNoiseX * ix + GeneratorNoiseY * iy + GeneratorNoiseZ * iz + GeneratorSeed * seed) & 0xffffffff;
            
            i ^= (i >> GeneratorShift);
            i &= 0xff;

            double xvg = Randoms[(i << 2)];
            double yvg = Randoms[(i << 2) + 1];
            double zvg = Randoms[(i << 2) + 2];
            double xvp = (fx - ix);
            double yvp = (fy - iy);
            double zvp = (fz - iz);
        ...
        {
            double a3 = Math.Pow(value, 3);//  value * value * value;
            double a4 = a3 * value;
            double a5 = a4 * value;
        ...
        {
            long n = (GeneratorNoiseX * x + GeneratorNoiseY * y + GeneratorNoiseZ * z + GeneratorSeed * seed) & 0x7fffffff;
            n = (n >> 13) ^ n;
    ...
    //Simple Vector 3 implementation.
