...
namespace LibNoise.Operator
{
    ...
    public class ScaleBias : ModuleBase
    {
        ...
        [DisplayName("Bias")]
        [Description("Sets the bias to apply to the scaled output value from the source module.")]
        ...
        [Category("Noise Settings")]
        [DisplayName("Scale")]
        [Description("Sets the scaling factor to apply to the output value from the source module.")]
        [Editor("DoubleUpDownEditor", "DoubleUpDownEditor")]
        ...
        {
            return "Noise module that applies a scaling factor and a bias to the output value from a source module.";
        }
        ...
        {
            return Modules[0].GetValue(x, y, z, scale) * this.Scale + Bias;
        }
