...
namespace LibNoise.Operator
{
    ...
    public class Power : ModuleBase
    {
        ...
        {
            return "Noise module that raises the output value from a first source module to the power of the output value from a second source module.";
        }
        ...
        {
            return Math.Pow(Modules[0].GetValue(x, y, z, scale), Modules[1].GetValue(x, y, z, scale));
        }
