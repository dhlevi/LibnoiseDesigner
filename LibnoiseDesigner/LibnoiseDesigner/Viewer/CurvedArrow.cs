...
namespace NetworkView
{
    ...
    public class CurvedArrow : Shape
    {
        ...
        public static readonly DependencyProperty AnimateProperty =
            DependencyProperty.Register("Animate", typeof(bool), typeof(CurvedArrow),
        ...
        public bool Animate
        {
            ...
            set
            {
                if (value)
                {
                    ...
                    this.StrokeDashArray = new DoubleCollection(new double[] { 2, 3 });
                    ...
                    this.BeginAnimation(CurvedArrow.StrokeDashOffsetProperty, anim);
                }
                else
                {
